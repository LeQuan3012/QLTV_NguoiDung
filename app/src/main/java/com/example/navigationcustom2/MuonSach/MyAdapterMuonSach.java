package com.example.navigationcustom2.MuonSach;
...
import com.example.navigationcustom2.Fregment.TraSachFragment;
...
public class MyAdapterMuonSach extends RecyclerView.Adapter<MyAdapterMuonSach.MyViewHolderMuonSach> {
    ...
    public void setData(List<MyMuonSach> list){
    ...
    public void onBindViewHolder(@NonNull MyViewHolderMuonSach holder, int position) {
        MyMuonSach obj = listmuonsach.get(position);
        ...
        holder.txtslmuon.setText("Số lượng mượn: "+daoMuonSach.getSLMuonTheoSach(obj.getMamuonsach(),obj.getMasach(), obj.getMaquanly()));
        holder.txtngaytrasach.setText("Ngày trả: "+daoMuonSach.getNgayTraMuonSachTheoSach(obj.getMasach(), obj.getMaquanly()));
        ...
        if(daoMuonSach.getTinhTrangMuon(obj.getMamuonsach())==0){
            ...
            holder.btntrasach.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    TraSachFragment a = new TraSachFragment();
