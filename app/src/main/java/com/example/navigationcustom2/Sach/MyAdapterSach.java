...
import com.example.navigationcustom2.Fregment.XemChiTietSachFragment;
...
public class MyAdapterSach extends RecyclerView.Adapter<MyAdapterSach.ViewHolderSach> {
    ...
    public void setData(List<MySach> l){
        this.listsach = l;
    ...
    public ViewHolderSach onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.iteamsach, parent,false);
        return new ViewHolderSach(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolderSach holder, int position) {
        MySach a = listsach.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                XemChiTietSachFragment a = new XemChiTietSachFragment();
